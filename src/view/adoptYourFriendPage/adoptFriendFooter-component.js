...
function createAdoptFriendFooterComponentTemplate() {
  return `
   <footer class="footer-section readMoreStorys__footter">
...
export default class AdoptFriendFooterComponent {
  getTemplate() {
    return createAdoptFriendFooterComponentTemplate();
  }
