...
function createAdoptFriendRightReservedComponentTemplate() {
  return `
...
export default class AdoptFriendRightReservedComponent {
  getTemplate() {
    return createAdoptFriendRightReservedComponentTemplate();
  }
