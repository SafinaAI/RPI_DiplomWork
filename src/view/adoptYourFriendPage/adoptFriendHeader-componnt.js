...
function createAdoptYourFriendHeaderComponentTemplate() {
  return `
...
export default class AdoptYourFriendHeaderComponent {
  getTemplate() {
    return createAdoptYourFriendHeaderComponentTemplate();
  }
