...
function createCareRightsReservedSecComponentTemplate() {
  return `
...
export default class CareRightsReservedSecComponent {
  getTemplate() {
    return createCareRightsReservedSecComponentTemplate();
  }
  getElement() {
    if (!this.element) {
