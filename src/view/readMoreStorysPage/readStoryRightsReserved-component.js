...
function createReadStorysRightReservedComponentTemplate() {
  return `
...
export default class ReadStorysRightReservedComponent {
  getTemplate() {
    return createReadStorysRightReservedComponentTemplate();
  }
