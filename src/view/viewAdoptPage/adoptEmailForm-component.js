...
function createAdoptEmailFormComponentTemplate() {
  return `<section class="seventh-section">
...
export default class AdoptEmailFormComponent {
  getTemplate() {
    return createAdoptEmailFormComponentTemplate();
  }
